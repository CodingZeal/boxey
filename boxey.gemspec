Gem::Specification.new do |s|
  ...
  s.version     = '0.0.1'
  s.date        = '2012-10-11'
  s.summary     = "Element reference operator for ActiveRecords."
  ...
  s.homepage    = 'http://rubygems.org/gems/boxey'

  s.add_dependency 'activerecord'
  s.add_development_dependency "rspec"
  s.add_development_dependency "smooth-jazz-nyan-cat-formatter"
